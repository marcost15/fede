<?php /* Smarty version 2.6.26, created on 2015-06-25 18:58:08
         compiled from consmod_personal_inspector.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'consmod_personal_inspector.html', 25, false),)), $this); ?>
﻿<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "cabecera.html", 'smarty_include_vars' => array('title' => 'Consultas de Ing')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>

<h4>BUSQUEDA DE ING INSPECTOR / RESIDENTE</h4>

<?php echo $this->_tpl_vars['f1']; ?>


<?php if ($this->_tpl_vars['datos']): ?>
<h4>Ing Inspector / Residente Solicitado</h4>
<div id="resultados">
...
">
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['cedula']; ?>
</td>
...
, <?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['nombre']; ?>
		...
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['civ']; ?>
</td>
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['tipo']; ?>
</td>
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['tlf']; ?>
</td>
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['correo']; ?>
</td>
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['modalidad']; ?>
</td>
		<td><a href="modificar_contratos_personal.php?id=<?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['id']; ?>
...
<?php else: ?>
	<?php if ($this->_tpl_vars['error1'] == 2): ?> 
		<h3>NO SE ENCONTRÓ ING CON ESOS PARAMETROS, VERIFIQUE...</h3>
	<?php endif; ?>
<?php endif; ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
