<?php /* Smarty version 2.6.26, created on 2016-01-01 01:38:16
         compiled from municipios.html */ ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "cabecera.html", 'smarty_include_vars' => array('title' => 'Municipio')));
...
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['municipios']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
<tr>
	<td><?php echo $this->_tpl_vars['municipios'][$this->_sections['i']['index']]['nombre']; ?>
</td>
	<td width="10%"><a href="?id=<?php echo $this->_tpl_vars['municipios'][$this->_sections['i']['index']]['id']; ?>
