...
if (bd_verificar_privilegios('rp_frm_evaluacionesxfecha.php',$_SESSION['usuario']['nivel_id'])!='CONCEDER')
{
...
function procesar($d)
{
	...
	else
	{
		...
		ir("rp_cons_evaluacionesxfecha.php?fecha_ini=$fecha_ini&fecha_fin=$fecha_fin");
	}
}
